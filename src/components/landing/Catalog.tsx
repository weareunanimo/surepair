          ...
          {solutions.map((s, i) => (
            <Reveal key={s.slug} delay={i * 0.06}>
              <Link
                ...
                params={{ slug: s.slug }}
                preload="intent"
                className="group block h-full text-left w-full rounded-2xl border border-white/8 bg-slate-900/40 p-8 hover:border-emerald-400/40 hover:bg-slate-900/70 transition-all"
              >
