...
export function Hero() {
  return (
    <Reveal as="section" className="pt-40 pb-28 px-6">
      <div className="mx-auto max-w-5xl text-center">
        ...
        <h1 className="mt-8 text-5xl md:text-7xl leading-[1.02]">
          IA para o seu negócio,
          <br />
          <span className="text-gradient-emerald">sem freelancer genérico.</span>
        </h1>
        <p className="mt-8 text-lg text-slate-400 max-w-2xl mx-auto font-light">
          A Surepair conecta pequenos negócios a programadores de IA certificados através
          de demandas pré-definidas. Escopo claro, preço fixo, entrega garantida.
        </p>
